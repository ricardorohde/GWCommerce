object ViewGerenciarNotasFiscais: TViewGerenciarNotasFiscais
  Left = 0
  Top = 0
  ...
  object gridNotasFiscais: TDBGrid
    ...
    TitleFont.Style = []
    OnDrawColumnCell = gridNotasFiscaisDrawColumnCell
    Columns = <
      item
        Expanded = False
        FieldName = 'ID_NFE'
  ...
  object pnl3: TPanel
    ...
    object dtpDataEmissao: TDateTimePicker
      ...
      BevelInner = bvNone
      BevelOuter = bvNone
      Date = 43990.900187951390000000
      Time = 43990.900187951390000000
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
  ...
  object dsNotasFiscais: TDataSource
    DataSet = dmDados.cliConsultaNotasFiscais
    OnDataChange = dsNotasFiscaisDataChange
    Left = 304
    Top = 168
  end
end
